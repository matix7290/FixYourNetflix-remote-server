    ...
    constructor() {
        ...
        */
        this.increaseVideoCount = async () => {
            const experiment_variables = await _utils_custom_ChromeStorage__WEBPACK_IMPORTED_MODULE_0__.ChromeStorage.get_experiment_variables();
            experiment_variables.video_index += 1;
            this.logger.log(`Increasing video count to ${experiment_variables.video_index}`);
            await _utils_custom_ChromeStorage__WEBPACK_IMPORTED_MODULE_0__.ChromeStorage.set_experiment_variables(experiment_variables);
        };
        this.listenForVideoStart = () => {
        ...
        this.logger = new _utils_custom_CustomLogger__WEBPACK_IMPORTED_MODULE_1__.CustomLogger("[Controller]");
    }
...
/* harmony import */ var _utils_custom_ChromeStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/custom/ChromeStorage */ "./src/utils/custom/ChromeStorage.ts");
...
chrome.runtime.onInstalled.addListener(async () => {
    ...
    await _utils_custom_ChromeStorage__WEBPACK_IMPORTED_MODULE_3__.ChromeStorage.initialize_default(); // same as --> chrome.storage.local.set(STORAGE_DEFAULT)
